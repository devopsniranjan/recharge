...
import hdfc.core.api
import hdfc.core.createComponents
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = hdfc.core.api as Api<T>
    override val config: ApplicationConfig = hdfc.core.config
}
